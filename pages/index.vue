<template lang="pug">
  div
    h1.big-title.mb-3.text-xs-center ウェブデベロッパー　スキルツリー
    v-layout(row justify-content-between align-center)
      div.skill-container.mb-5.pl-3
        // base-skilltree
      ...
      // 右側
      div.pl-5
        v-layout(row justify-content-between style="width: 100%;")
          h1.base-level-label BASEレベル
          h1.base-level-label &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{currentBasePoint}}
        v-layout(row justify-content-between style="width: 100%;")
          h1.front-level-label FRONTENDレベル
          h1.front-level-label &nbsp;&nbsp;{{currentFrontPoint}}
        v-layout(row justify-content-between)
          h1.back-level-label BACKENDレベル
          h1.back-level-label &nbsp;&nbsp;&nbsp;&nbsp{{currentBackendPoint}}
        v-layout(row justify-content-between)
          h1.dev-level-label DEVOPSレベル
          h1.dev-level-label &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{currentDevopsPoint}}
        v-layout(row justify-content-between)
          h1.sum-level-label 合計
          h1.sum-level-label &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{sumLevel}}
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      clickableBack2() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1;},
      clickableBack3() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 1;},
      clickableBack4() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 2;},
      clickableBack5() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 3;},
      clickableBack6() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 4;},
      clickableBack7() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 5;},
      clickableBack8() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 6;},
      clickableBack9() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 7;},
      clickableBack10() {return this.currentBasePoint >= this.baseBorder && this.currentBackendPoint >= 1 + 3 * 8;},
      ...
      // 合計レベル
      sumLevel() {
        return this.currentBasePoint + this.currentFrontPoint + this.currentBackendPoint + this.currentDevopsPoint
      }
    }
  }
</script>
